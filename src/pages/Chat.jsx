...
const Chat = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-100">
      <div className="border-b bg-white px-6 py-4 shadow">
      ...
      <div className="border-t bg-white px-6 py-4">
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 rounded-xl border border-slate-200 px-4 py-3 text-sm focus:border-blue-400 focus:outline-none"
          />
          <button
            type="button"
            onClick={handleSend}
